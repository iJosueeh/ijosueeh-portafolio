    ...
    <div className="flex flex-col sm:flex-row items-center justify-between border-t border-purple-900/60 pt-1.5 gap-2">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="neo-pixel-btn py-1.5 px-3 bg-[#1b1335] hover:bg-[#251a4a] text-purple-200 hover:text-white font-mono text-xs border border-purple-900/80 cursor-pointer flex items-center gap-1"
          type="button"
        >
        ...
        <a
          ...
          onMouseEnter={() => playRetroBeep('hover')}
          className="neo-pixel-btn py-1.5 px-4 bg-gradient-to-r from-arcade-magenta to-[#e11d48] hover:from-[#f43f85] hover:to-[#fb7185] text-white font-arcade text-[10px] sm:text-xs font-bold tracking-wider uppercase flex items-center gap-1.5 border border-pink-300/80 cursor-pointer shadow-[3px_3px_0px_#500724]"
        >
          <span>▶</span>
          <span>VER LOGROS [ENTER]</span>
        </a>
      </div>
    </div>
  );
