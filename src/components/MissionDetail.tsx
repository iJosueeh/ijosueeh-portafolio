...
export const MissionDetail: React.FC<MissionDetailProps> = ({ missionId = 'jaldishop' }) => {
  ...
  return (
    <main
      className="w-full max-w-5xl mx-auto my-auto z-10 flex flex-col items-center justify-center py-2 sm:py-3"
    ...
    >
      ...
      >
        {/* Header Strip */}
        <div className="flex flex-wrap items-center justify-between border-b border-purple-900/60 pb-2.5 mb-4 gap-2">
          <div className="flex items-center gap-2">
            <span className="font-arcade text-[9px] sm:text-[10px] text-arcade-cyan tracking-wider bg-cyan-950/30 px-2.5 py-0.5 border border-cyan-500/40">
        ...
        <div className="mb-4">
          <h1 className="font-arcade text-xl sm:text-2xl lg:text-3xl text-white tracking-wider uppercase drop-shadow-[0_2px_0_#000]">
            {mission.title}
          </h1>
          <p className="font-mono text-[11px] sm:text-xs text-pink-300 tracking-widest uppercase font-bold mt-1">
            {mission.tagline}
          </p>
          <div className="h-0.5 w-20 bg-gradient-to-r from-arcade-magenta to-arcade-cyan mt-1.5" />
        </div>

        {/* 2-Column Content Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-7 items-center mb-5">
